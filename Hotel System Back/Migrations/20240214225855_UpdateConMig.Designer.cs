...
namespace Hotel_System_Back.Migrations
{
    ...
    [Migration("20240214225855_UpdateConMig")]
    partial class UpdateConMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.CommonTable", b =>
                {
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.FeedBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.MemberShip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Reservation", b =>
                {
                    b.Property<int>("ClientId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.TransactionTable", b =>
                {
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Client", b =>
                {
                    b.HasBaseType("Hotel_System_Back.Models.Person");
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Employee", b =>
                {
                    b.HasBaseType("Hotel_System_Back.Models.Person");
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("Hotel_System_Back.Models.Payment", "Payment")
                        .WithMany()
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hotel_System_Back.Models.Room", "Room")
            ...
            modelBuilder.Entity("Hotel_System_Back.Models.Client", b =>
                {
                    b.HasOne("Hotel_System_Back.Models.MemberShip", "MemberShip")
                        .WithMany()
